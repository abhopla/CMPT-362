...
import com.example.dolladollabills.databinding.FragmentAugmonthlyspendingBinding
...
class AugSpendingFragment : Fragment() {
    private var _binding: FragmentAugmonthlyspendingBinding? = null
...
//    private val currentMonth = LocalDateTime.now().month.value //ex. AUGUST = 8
    private val currentMonth = 8 // Aug
    ...
    override fun onCreateView(
        ...
        _binding = FragmentAugmonthlyspendingBinding.inflate(inflater, container, false)
