...
class JulSpendingFragment : Fragment() {
    private var _binding: FragmentJulmonthlyspendingBinding? = null
...
//    private val currentMonth = LocalDateTime.now().month.value //ex. AUGUST = 8
    private val currentMonth = 7 // Jul
    ...
    override fun onCreateView(
        ...
        _binding = FragmentJulmonthlyspendingBinding.inflate(inflater, container, false)
