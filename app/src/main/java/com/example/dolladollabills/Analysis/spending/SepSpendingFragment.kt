...
import com.example.dolladollabills.databinding.FragmentSepmonthlyspendingBinding
...
class SepSpendingFragment : Fragment() {
    private var _binding: FragmentSepmonthlyspendingBinding? = null
...
//    private val currentMonth = LocalDateTime.now().month.value //ex. AUGUST = 8
    private val currentMonth = 9 //Sep
    ...
    override fun onCreateView(
        ...
        _binding = FragmentSepmonthlyspendingBinding.inflate(inflater, container, false)
