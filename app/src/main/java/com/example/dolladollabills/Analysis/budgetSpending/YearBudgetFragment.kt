...
class YearBudgetFragment : Fragment() {
    private var _binding: FragmentYearbudgetBinding? = null
...
//    private val currentMonth = LocalDateTime.now().month.value //ex. AUGUST = 8 >
    ...
    override fun onCreateView(
        ...
        _binding = FragmentYearbudgetBinding.inflate(inflater, container, false)
