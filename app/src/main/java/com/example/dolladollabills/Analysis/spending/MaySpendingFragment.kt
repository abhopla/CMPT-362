...
class MaySpendingFragment : Fragment() {
    private var _binding: FragmentMaymonthlyspendingBinding? = null
...
//    private val currentMonth = LocalDateTime.now().month.value //ex. AUGUST = 8
    ...
    override fun onCreateView(
        ...
        _binding = FragmentMaymonthlyspendingBinding.inflate(inflater, container, false)
