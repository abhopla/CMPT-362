...
class QuaterlyFragment : Fragment() {
    private var _binding: FragmentQuaterlyBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = FragmentQuaterlyBinding.inflate(inflater, container, false)
        val view = binding.root

        val aaChartView = binding.chart2
