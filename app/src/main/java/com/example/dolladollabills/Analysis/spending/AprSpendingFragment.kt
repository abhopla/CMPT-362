...
class AprSpendingFragment : Fragment() {
    private var _binding: FragmentAprmonthlyspendingBinding? = null
...
//    private val currentMonth = LocalDateTime.now().month.value //ex. AUGUST = 8
    private val currentMonth = 4 // Apr
    ...
    override fun onCreateView(
        ...
        _binding = FragmentAprmonthlyspendingBinding.inflate(inflater, container, false)
