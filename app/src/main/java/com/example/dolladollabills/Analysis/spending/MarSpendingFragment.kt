...
import com.example.dolladollabills.databinding.FragmentMarmonthlyspendingBinding
...
class MarSpendingFragment : Fragment() {
    private var _binding: FragmentMarmonthlyspendingBinding? = null
...
//    private val currentMonth = LocalDateTime.now().month.value //ex. AUGUST = 8
    private val currentMonth = 3 //Mar
    ...
    override fun onCreateView(
        ...
        _binding = FragmentMarmonthlyspendingBinding.inflate(inflater, container, false)
