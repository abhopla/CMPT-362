...
class YearSpendingFragment : Fragment() {
    private var _binding: FragmentFebmonthlyspendingBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = FragmentFebmonthlyspendingBinding.inflate(inflater, container, false)
