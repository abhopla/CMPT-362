...
import com.example.dolladollabills.databinding.FragmentDecmonthlyspendingBinding
...
class DecSpendingFragment : Fragment() {
    private var _binding: FragmentDecmonthlyspendingBinding? = null
...
//    private val currentMonth = LocalDateTime.now().month.value //ex. AUGUST = 8
    private val currentMonth = 12 //Dec
    ...
    override fun onCreateView(
        ...
        _binding = FragmentDecmonthlyspendingBinding.inflate(inflater, container, false)
