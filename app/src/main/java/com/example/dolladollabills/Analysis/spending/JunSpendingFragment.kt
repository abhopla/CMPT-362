...
import com.example.dolladollabills.databinding.FragmentJunmonthlyspendingBinding
...
class JunSpendingFragment : Fragment() {
    private var _binding: FragmentJunmonthlyspendingBinding? = null
...
//    private val currentMonth = LocalDateTime.now().month.value //ex. AUGUST = 8
    private val currentMonth = 6 //Jun
    ...
    override fun onCreateView(
        ...
        _binding = FragmentJunmonthlyspendingBinding.inflate(inflater, container, false)
